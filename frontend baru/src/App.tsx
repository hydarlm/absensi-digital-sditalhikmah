      ...
      <AuthProvider>
        ...
        <BrowserRouter>
          <Routes>
            ...
            <Route element={<DashboardLayout title="Manajemen Kelas" subtitle="Kelola daftar kelas dan jadwal keterlambatan" />}>
              <Route path="/dashboard/classes" element={<ClassSchedulePage />} />
            </Route>
