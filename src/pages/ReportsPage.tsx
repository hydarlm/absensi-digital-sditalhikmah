...
import { attendanceService, SemesterReport } from '@/services/attendance';
...
export default function ReportsPage() {
  ...
  const summary = {
    ...
    avgAttendance: reports.length > 0 ? Math.round(reports.reduce((sum, r) => sum + r.attendancePercentage, 0) / reports.length) : 0,
    totalPresent: reports.reduce((sum, r) => sum + r.totalPresent, 0),
    totalLate: reports.reduce((sum, r) => sum + r.totalLate, 0),
    totalSick: reports.reduce((sum, r) => sum + r.totalSick, 0),
    totalPermission: reports.reduce((sum, r) => sum + r.totalPermission, 0),
    totalAbsent: reports.reduce((sum, r) => sum + r.totalAbsent, 0),
  };
